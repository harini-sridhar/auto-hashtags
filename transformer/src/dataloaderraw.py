...
class DataLoaderRaw():
    ...
    def __init__(self, opt):
        ...
        self.my_resnet.load_state_dict(torch.load('src/data/imagenet_weights/'+self.cnn_model+'.pth', map_location=lambda storage, loc: storage))
        self.my_resnet = myResnet(self.my_resnet)
        #self.my_resnet.cuda()
        self.my_resnet.to(device)
        self.my_resnet.eval()
