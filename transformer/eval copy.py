...
hash_cap = ["#" + word for word in caption_tags]
#print ('hash_cap: ', hash_cap)
image = Image.open('./images/kite.jpg')
st.image(image)
#st.image(image, caption=' '.join(hash_cap))
#st.image(image, caption=hash_cap)
st.write('actual caption: ', caption)
#st.write('Insta tags: ')
hash_instatags = ["#" + word for word in random_tags] + hash_cap
#for hash in hash_instatags:
#    st.write(hash),
